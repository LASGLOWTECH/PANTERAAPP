    ...
    <div className="bg-dark text-white font-inter">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-12 text-center">
          ...
          <div className="flex bg-dark   shadow-md border-amber-400  hover:border-1  p-4 flex-col items-center">
            <FaStar className="fill-gold2 text-5xl mb-4" />
          ...
          <div className="flex bg-dark   shadow-md hover:hover:border-amber-400 hover:border-1 p-6 flex-col items-center">
            <FaLightbulb className="text-footer-accent fill-gold2 text-5xl mb-4" />
          ...
          <div className="flex flex-col items-center  bg-dark   shadow-md border-amber-400  hover:border-1">
            <FaLeaf className="text-footer-accent fill-gold2 text-5xl mb-4" />
